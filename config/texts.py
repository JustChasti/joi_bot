...
HELLO_TEXT = (
    ...
    "🤝 Знакомые → 💛 Друзья → ❤️ Романтические партнеры\n"
    "Каждое сообщение приближает вас друг к другу.\n"
    "💬 Бесплатно доступно ограниченное количество сообщений. "
    "При оформлении подписки ты сможешь отправлять до <b>25 сообщений в сутки</b> "
    "и продолжать развивать отношения без перерывов.\n\n"
    "Напиши первое сообщение — и ваша история начнётся прямо сейчас.\n\n"
    "Доступные команды:\n"
